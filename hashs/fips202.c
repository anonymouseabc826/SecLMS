...
/* REVIEW B04-R6: LMS only uses shake256(); the shake128 family and sha3_256/sha3_512 etc. are upstream
 * dead code kept intact, not trimmed. */
...
/*************************************************
* The following shake128_* / sha3_256 / sha3_512 interfaces are kept fully intact upstream but unused by LMS
* (REVIEW B04-R6): the LMS path only uses shake256 (XOF, 32-byte output).
